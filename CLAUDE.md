...
This project is indexed by GitNexus as **examine-API** (1457 symbols, 2132 relationships, 46 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
