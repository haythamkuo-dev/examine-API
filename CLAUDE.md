...
This project is indexed by GitNexus as **examine-API** (1226 symbols, 1813 relationships, 43 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
