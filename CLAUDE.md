...
This project is indexed by GitNexus as **examine-API** (1297 symbols, 1907 relationships, 46 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
