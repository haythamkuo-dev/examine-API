...
This project is indexed by GitNexus as **examine-API** (1540 symbols, 2284 relationships, 53 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
