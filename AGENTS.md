...
This project is indexed by GitNexus as **examine-API** (1512 symbols, 2235 relationships, 55 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
